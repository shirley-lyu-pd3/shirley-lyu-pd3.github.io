...
var file = "src/node_modules/@sapper/internal/error.svelte"; // (10:0) {#if "development" === 'development'}
...
function create_if_block(ctx) {
  ...
  var block = {
    ...
    p: function update(ctx, dirty) {
      ...
      1 && t_value !== (t_value =
      /*error*/
      ctx[0].stack + "")) set_data_dev(t, t_value);
    },
    d: function destroy(detaching) {
...
function create_fragment$1(ctx) {
  ...
  var block = {
    ...
    p: function update(ctx, _ref) {
      ...
      1 && t2_value !== (t2_value =
      /*error*/
      ctx[0].message + "")) set_data_dev(t2, t2_value);
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  var writable_props = ["error", "status"];
  Object.keys($$props).forEach(function (key) {
...
var components = [{
  js: function js() {
    return Promise.all([import('./index.34da5eb1.js'), ]).then(function(x) { return x[0]; });
  }
}, {
  js: function js() {
    return Promise.all([import('./work-mode-selection.b1bffeba.js'), __inject_styles(["work-mode-selection-53aa844b.css"])]).then(function(x) { return x[0]; });
  }
}, {
  js: function js() {
    return Promise.all([import('./static-standing.ba38c747.js'), __inject_styles(["static-standing-1cd2744f.css"])]).then(function(x) { return x[0]; });
  }
}, {
  js: function js() {
    return Promise.all([import('./static-sitting.535d2c5e.js'), __inject_styles(["static-sitting-41fbb322.css"])]).then(function(x) { return x[0]; });
  }
}, {
  js: function js() {
    return Promise.all([import('./exercise-end.fc302e6f.js'), __inject_styles(["exercise-end-660ed87d.css"])]).then(function(x) { return x[0]; });
  }
}, {
  js: function js() {
    return Promise.all([import('./exercise.55c1167d.js'), __inject_styles(["exercise-c4bed802.css"])]).then(function(x) { return x[0]; });
  }
}, {
  js: function js() {
    return Promise.all([import('./movement.0bc25ad1.js'), __inject_styles(["movement-5bd0eaa0.css"])]).then(function(x) { return x[0]; });
  }
}, {
  js: function js() {
    return Promise.all([import('./setting.f575c69f.js'), __inject_styles(["setting-dff5266f.css"])]).then(function(x) { return x[0]; });
  }
}, {
  js: function js() {
    return Promise.all([import('./warning.eece366c.js'), __inject_styles(["warning-1a50a43d.css"])]).then(function(x) { return x[0]; });
  }
}];
var routes = [{
  // index.svelte
  ...
  // work-mode-selection.svelte
  pattern: /^\/work-mode-selection\/?$/,
  parts: [{
    i: 1
  }]
}, {
  // static-standing.svelte
  pattern: /^\/static-standing\/?$/,
  parts: [{
    i: 2
  }]
}, {
  // static-sitting.svelte
  pattern: /^\/static-sitting\/?$/,
  parts: [{
    i: 3
  }]
}, {
  // exercise-end.svelte
  pattern: /^\/exercise-end\/?$/,
  parts: [{
    i: 4
  }]
}, {
...
export { create_component as A, claim_component as B, mount_component as C, transition_in as D, transition_out as E, destroy_component as F, SvelteComponentDev as S, _inherits as _, _getPrototypeOf as a, _possibleConstructorReturn as b, _classCallCheck as c, _assertThisInitialized as d, dispatch_dev as e, element as f, space as g, claim_element as h, init as i, children as j, claim_text as k, detach_dev as l, claim_space as m, add_location as n, attr_dev as o, insert_dev as p, append_dev as q, noop as r, safe_not_equal as s, text as t, onMount as u, validate_slots as v, _createClass as w, set_style as x, listen_dev as y, _slicedToArray as z };
